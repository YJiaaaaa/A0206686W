# -*- coding: utf-8 -*-
"""
This python coding pushes data from train_FD001.txt to the aws platform.
...
PRIVATE_KEY = "5e8f247755-private.pem.key"

# The relative path to your certificate file that
# &IoT; generated for this device, which you 
# have already saved onto this device.
CERT_FILE = "5e8f247755-certificate.pem.crt.txt"

# A programmatic shadow handler name prefix.
SHADOW_HANDLER = "A0206686W_DataOne"
...
engineDF.id = engineDF.id.map(lambda x: 'FD001_' + str(int(x)))
